       ...
       <div className="row justify-content-md-center">
        <div className="col-lg-5">
          <p className="text-muted text-center" style={{ marginTop: 50 }}>
            Idea y desarrollo:
            <a rel="noopener noreferrer" target="_blank" href="https://twitter/mcarvajal_"> Miguel Carvajal</a>. Coordinación y proyección: <a rel="noopener noreferrer" target="_blank" href="https://twitter/jagaraviles">José A. García Avilés</a>.
