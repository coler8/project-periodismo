    var cliches1 = [
        ...
        'Abrir los ojos',
        'Abrir un melón',
        'Abrir una puerta a algo',
        'Abrir una ventana a algo',
        ...
        'Dar carta blanca',
        'Dar cartas en el asunto',
        'Dar cera a alguien',
        'Dar cien vueltas',
        'Dar coba',
        'Dar coces',
        'Dar con la tecla',
        'Dar con tus huesos en un sitio',
        'Dar cosa',
        'Dar cuerda',
        ...
        'Darle leña al mono que es de goma',
        'Darle para el pelo',
        'Darle un patatús',
        'Darle un repaso',
        'Darlo todo',
        ...
        'Decir paridas',
        'Decirse las verdades a la cara',
        'Decisión salomónica',
        'Declarar la guerra',
        ...
        'Hacer chanchullos',
        'Hacer como quien no quiere la cosa',
        ...
        'Hacer el payaso',
        'Hacer el primo',
        'Hacer el propósito de la enmienda',
        ...
        'Hacer las delicias de chicos y grandes',
        'Hacer las maletas',
        ...
        'Hacer valer el resultado',
        'Hacerle el caldo gordo',
        'Hacerle el vacío',
        'Hacerle la cama',
        'Hacerle la pascua',
        ...
        'Inyectar liquidez',
        'Ir a escote',
        'Ir a freír espárrafos',
        'Ir a piñón fijo',
        'Ir a por todas',
        'Ir a rebufo de alguien',
        'Ir a su aire',
        'Ir a tiro hecho',
        'Ir a toda pastilla',
        'Ir al grano',
        ...
        'Ir con el piloto económico',
        'Ir con el viento de cara',
        'Ir con la cabeza bien alta',
        'Ir con la cara larga',
        'Ir de cara',
        'Ir de carabina',
        'Ir de farol',
        'Ir de flor en flor',
        ...
        'Poner a huevo',
        'Poner a parir',
        'Poner al zorro a guardar gallinas',
        ...
        'Poner en un brete',
        'Poner en valor',
        'Poner encima de la mesa un tema',
        ...
        'Ponerle la cruz a alguien',
        'Ponerlo todo muy bonito',
    ...
    var auxiliares=[
        'he', 'había','habré', 'hube','haya', 'hubiera','hubiere','habría', //primera singular
        'hemos', 'habíamos', 'habremos', 'hubimos', 'hayamos', 'hubiéramos','habríamos', //primera plural
        'has', 'habías', 'habrás', 'hubiste', 'hayas', 'hubieras', 'hubieres','habrías', //segunda singular
        'habéis', 'habíais', 'habréis', 'hubisteis', 'hayáis', 'hubierais', 'hubiereis','habríais', //segunda singular
        'ha', 'había', 'habrá', 'hubo', 'haya', 'hubiera', 'hubiere','habría', //tercera singular
        'han', 'habían', 'habrán', 'hubieron', 'hayan', 'hubieran', 'hubieren','habrían' //tercera plural
    ];
    ...
    var suffix_ar=[
        ...
        'áis','abais','asteis','aréis','éis','arais','aseis','aríais','ad',
        'aba','ó','ará','an','aban','aron','arán','en','aran','asen','aren','arían','en'
   ];

    var suffix_er=[
        'er','iendo','ido','ida','idos','idas','o','ía','í','eré','a','iera','iese','iere','ería',
        'emos','íamos','imos','eremos','amos','iéramos','iéremos','eríamos','amos',
        'es','és','ías','iste','istes','erás','as','ás','ieras','ieses','ieres','erías',
    ...
    var suffix_ir=[
        ...
        'íais','isteis','iréis','áis','ierais','ieseis','iereis','iríais','id','áis',
    ...
    var cliches = [
        {verbo: 'hac', frase: ' el cabra', suffixes: suffix_er},
        {verbo: 'hac', frase: ' el payaso', suffixes: suffix_er},
        {verbo: 'est', frase: ' de morros', suffixes: suffix_estar},
    ...
    var verb = cliches.map(function(verbos) {
        return verbos.verbo;
    });

    var sentence = cliches.map(function(frases) {
        return frases.frase;
    });

    var sufij = cliches.map(function(sufi) {
    ...
    //dividirlos en los verbos con la terminacion ar , er , ir
    var sufijos=[
        'o', 'e', 'a', 'as', 'es', 'amos', 'emos',
    ...
    var clicheVerb = new RegExp('\\b(' + clich.join('|') + ')\\b', 'gi');

    var clicheRegex = new RegExp('\\b(' + '(' + conjugar_verbs.join('|') + ')('+sufijos.join('|')+')+(' + cliche_no_verbs.join('|') + '))\\b', 'gi');
    //clicheRegex1[i]= new RegExp('\\b(' + '(' + verb[i] + ')('+suf.join('|')+')+(' + sentence[i] + '))\\b', 'gi');

    /*
    var elements = ['((hac)(o|e)+( el payaso))'];
    var element2 = ['((est)(o|e)+( de morros))'];

    console.log(elements.concat(element2).join('|'));
    */

    /*
    var verb=['salir','dormir'];
    var clicheRegex1=[];
    for(var i = 0; i <= verb.length; i++){
       clicheRegex1[i] = new RegExp('\\b(' + '(' + verb[i] + '))\\b', 'gi');

        console.log(clicheRegex1.concat(clicheRegex1[i]).join('|'));
    }*/
    ...
    for (var i = 0; i < cliches.length; i++) {
        //for (var i = 0; i < sufij.length; i++)
        clicheRegex1[i] = ('((' + verb[i] + ')(' + sufij[i] + ')+(' + sentence[i] + '))');

        frase = clicheRegex1.concat(clicheRegex1[i]).join('|');
    }


    var allCliches = new RegExp('\\b(' + frase + ')|('+ cliches1.join('|')+')\\b', 'gi');

    function conjugar_irregulares () {
        var super_array = [];
        console.log(conjugar_verbs[5]);
        if(conjugar_verbs[5]==='ir'){
    ...
    /*
        ...
        for (var i = 1; i <= cliche_no_verbs.length; i++) {
            conjugar_verbs.push(i);
            super_array.push(conjugar_verbs.concat());
    ...
    module.exports = function (text) {
        //conjugar_irregulares();
        //var allCliches;
        //allCliches=clicheVerb+'|'+finalCliche;
        //console.log(finalCliche);
